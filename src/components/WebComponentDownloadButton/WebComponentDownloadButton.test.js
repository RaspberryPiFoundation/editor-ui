...
import WebComponentDownloadButton from "./WebComponentDownloadButton";
...
describe("Downloading project with name set", () => {
  let webComponentDownloadButton;
  ...
  beforeEach(() => {
    ...
    render(
      <Provider store={store}>
        <WebComponentDownloadButton buttonText="Download" Icon={() => {}} />
      </Provider>,
    );
    webComponentDownloadButton = screen.queryByText("Download").parentElement;
  });

  test("Download button renders", () => {
    expect(webComponentDownloadButton).toBeInTheDocument();
  });
...
test("If login to save modal open, closes it when download clicked", () => {
  ...
  const webComponentDownloadButton =
    screen.queryByText("Download").parentElement;
  fireEvent.click(webComponentDownloadButton);
