...
const WebComponentLoader = (props) => {
  ...
  const user = useSelector((state) => { console.log("state.auth.user = ", state.auth.user); return state.auth.user });
